...
VALUES ('John Doe', 'johndoe@example.com', '1234567890', '123 Main St, Anytown, USA', 1985, 1, 1, 'Manager', 5000.00, 1),
		('Jane Smith', 'janesmith@example.com', '2345678901', '456 Oak Ave, Anytown, USA', 1990, 0, 1, 'Assistant Manager', 4000.00, 2),
		('Bob Johnson', 'bobjohnson@example.com', '3456789012', '789 Maple Rd, Anytown, USA', 1995, 1, 1, 'Clerk', 3000.00, 3),
		('Samantha Brown', 'samanthabrown@example.com', '4567890123', '321 Elm St, Anytown, USA', 1988, 0, 2, 'Engineer', 6000.00, 2),
		('Mark Davis', 'markdavis@example.com', '5678901234', '654 Pine Dr, Anytown, USA', 1992, 1, 2, 'Software Developer', 5500.00, 3),
		('Emily Jones', 'emilyjones@example.com', '6789012345', '987 Cedar Ln, Anytown, USA', 1993, 0, 2, 'Data Analyst', 4500.00, 3),
		('Tom Wilson', 'tomwilson@example.com', '7890123456', '159 Cherry St, Anytown, USA', 1987, 1, 3, 'Sales Manager', 5500.00,2 ),
		('Sarah Lee', 'sarahlee@example.com', '8901234567', '357 Rose Dr, Anytown, USA', 1989, 0, 3, 'Sales Representative', 3500.00, 3),
		('Mike Brown', 'mikebrown@example.com', '9012345678', '753 Peach Ave, Anytown, USA', 1991, 1, 3, 'Marketing Manager', 6000.00, 3),
		('Karen Chen', 'karenchen@example.com', '0123456789', '246 Berry Rd, Anytown, USA', 1994, 0, 2, 'Marketing Coordinator', 4000.00, 3);
